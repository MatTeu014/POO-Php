<?php
    ...
    $livro1 = new Livro(1,"Aventuras","Jorge","R$20,00","Disponivel");
    $livro2 = new Livro(2,"Era uma Vez","Roberto","R$15,00","Indisponivel");
    $compra1 = new Compra(1,$usuario1,"Cartão de Crédito",$livro1,20);
    $reserva1 = new Reserva($livro2);
    $operadoraCartao1 = new OperadoraCartao("9032193","1237182","senha");
