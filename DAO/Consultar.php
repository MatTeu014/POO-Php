            ...
            try{
                ...
                while($dados = mysqli_fetch_Array($result)){//enquanto existir dados, ele vai procurar o dado especifico
                    if($dados['codigo'] == $codigo){
                        echo "<br>Código: ".$dados['codigo']."<br>Logradouro: ".$dados['logradouro']."<br>Número: ".$dados['numero']."<br>Bairro: ".$dados['bairro']."<br>Cidade: ".$dados['cidade']."<br>Estado: ".$dados['estado']."<br>CEP: ".$dados['cep']."<br>País: ".$dados['pais'];
